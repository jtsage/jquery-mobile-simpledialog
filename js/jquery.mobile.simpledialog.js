    ...
    $.widget("mobile.simpledialog", $.mobile.widget, {
        ...
        open: function() {
            ...
            if (!o.disabled) {
                if ((docWinWidth > 400 && !o.useDialogForceTrue) || o.useDialogForceFalse || o.fullScreen) {
                    ...
                    self.pickerContent.removeClass('ui-overlay-shadow ui-simpledialog-hidden').css({
                        'top': 'auto',
                        'left': 'auto',
                        'marginLeft': 'auto',
                        'marginRight': 'auto'
                    }).css('zIndex', self.options.zindex);
                    $.mobile.changePage(self.pickPage, {
        ...
        _create: function() {
            ...
            if (o.isInit && o.allowReopen) {
                ...
                var thisPage = caller.closest('.ui-page'),
                    pickPage = $("<div data-role='dialog' class='ui-simpledialog-dialog' data-theme='" + o.pickPageTheme + "' >" + "<div data-role='header' data-backbtn='false' data-theme='a'>" + "<div class='ui-title'>" + o.prompt + "</div>" + "</div>" + "<div data-role='content'></div>" + "</div>"),
                    ct = null,
                    pickPageContent = null;

                if (o.mode === 'blank') {
                    ct = $("<div class='ui-simpledialog-container ui-overlay-shadow ui-corner-all ui-simpledialog-hidden " + ((o.animate === true) ? o.transition : '') + " ui-body-" + o.pickPageTheme + "'></div>");
                    ct.html(o.fullHTML);
                    $('[data-role=content]', pickPage).append(ct);
                }

                pickPage.appendTo($.mobile.pageContainer).page().css('minHeight', '0px').css('zIndex', o.zindex);

                if (o.animate === true) {
                    pickPage.addClass('pop');
                }
                ...
                $(document).bind('orientationchange', function(e) {
                    caller.trigger('orientationchange');
                });
        ...
        _buildPage: function() {
            var self = this,
                o = self.options,
                idx = null,
                pickerInput, pickerChoice, screen, pickerContent = $("<div>", {
                    "class": 'ui-simpledialog-container ui-overlay-shadow ui-corner-all ui-simpledialog-hidden ' + ((o.animate === true) ? o.transition : '') + ' ui-body-' + o.pickPageTheme
                }).css({
                    'zIndex': o.zindex,
                    'width': o.width
                }),
            ...
            if (o.mode !== 'blank') {
                ...
                if (o.mode === 'string') {
                    pickerInput = $("<div class='ui-simpledialog-controls'><input class='ui-simpledialog-input ui-input-text ui-shadow-inset ui-corner-all ui-body-" + o.pickPageInputTheme + "' type='" + ((o.inputPassword === true) ? "password" : "text") + "' name='pickin' /></div>").bind('keyup', function(event) {
                ...
                $.each(o.buttons, function(name, props) {
                    ...
                    idx = o.butObj.push($("<a href='#'>" + name + "</a>").appendTo(pickerChoice).buttonMarkup({
                        theme: props.theme,
                        icon: props.icon,
                        iconpos: props.iconpos,
                        corners: true,
                        shadow: true
                    }).unbind("vclick").unbind("click").bind(o.clickEvent, function() {
                        if (o.mode === 'string') {
                            self.caller.attr('data-string', pickerInput.find('input').val());
                        }
                    ...
                    if (props.insertSeparator) $("<div class='buttons-separator'>").appendTo(pickerChoice);
                });
            } else {
            ...
            screen = $("<div>", {
                ...
                'z-index': o.zindex - 1
            }).appendTo(self.thisPage).bind(o.clickEvent, function(event) {
                if (!o.forceInput) {
                    self.close();
                }
